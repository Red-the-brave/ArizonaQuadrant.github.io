...
}{for(var i = 0, len = gdjs.evtsExt__ShootExtension__Fire.GDLaserBulletObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ShootExtension__Fire.GDLaserBulletObjects1[i].setZOrder(0);
}
}}
